...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>()
            {
                ...
                new Product{ProductId = 3, CategoryId = 1, ProductName = "Hp Laptop", 
                    QuantityPerUnit = "8 Gb Ram", UnitPrice = 10000, UnitsInStock = 2},
            ...
            var result = from p in products
                join c in categories on p.CategoryId equals c.CategoryId where p.UnitPrice > 5000
        ...
        private static void AscDescTest(List<Product> products)
        {
            ...
            var result = products.Where(p => p.ProductName.Contains("top")).OrderByDescending
